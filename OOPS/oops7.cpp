...
int main()
{
    ...
    printf("Enter time quantum of queue1 and queue2 :");
    scanf("%d", &tq1);
    scanf("%d", &tq2);
    char c;
    ...
    for (i = 0; i < n; i++)
    {
        ...
        {
            time += Q1[i].RT;
            // from arrival time of first process to completion of this process /
            Q1[i].RT = 0;
            Q1[i].WT = time - Q1[i].AT - Q1[i].BT;
            // amount of time process has been waiting in the first queue /
            Q1[i].TAT = time - Q1[i].AT;
            // amount of time to execute the process /
    ...
    for (i = 0; i < k; i++)
    {
        ...
        {
            time += Q2[i].RT;
            // from arrival time of first process + BT of this process /
            Q2[i].RT = 0;
